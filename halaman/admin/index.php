...
<html>
  ...
  <body class="skin-blue">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="index.php?halaman=admin">Chief Executive Officier</a></li>
                <li><a href="index.php?halaman=staff">Customer Service</a></li>
                <li><a href="index.php?halaman=teknisi">Technical Support</a></li>
                </ul>
            </li>
            <li>
   ...
   else if (@$_GET['halaman']=='teknisi') {
    include "teknisi.php";
 }
 else if (@$_GET['halaman']=='teknisi_edit') {
    include "teknisi_edit.php";
 }
